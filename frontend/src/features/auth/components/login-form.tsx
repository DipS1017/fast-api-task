...
import { loginSchema, registerSchema, type LoginValues } from "../schema";
...
export function LoginForm() {
  ...
  // both schemas share the same `{ email, password }` shape, so a single form
  // value type works across the two modes.
